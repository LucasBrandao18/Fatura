...
public void imprimir(){
  System.out.println("Número: {0} ", this.numero);
  System.out.println("Descrição: {0} ", this.descricao);
  System.out.println("Quantidade: {0} ", this.quantidade);
  System.out.println("Preço: ", {0} this.preco);
  }
